<div class="comment-group mb-3 mt-3" data-aos="fade-up" align="center">
    <p class="title-comment mb-3 text-center">Đánh giá sản phẩm</p>
    @foreach ($sanpham as $item)
        <img src="{{ URL('images/' . $item->HINHANH) }}" alt="{{ $item->TENSANPHAM }}" width="100px" height="130px">
    ...
    <form class="form-comment" role="comment" action="{{ route('danhgias.themDanhGia') }}" method="POST">
        ...
        <input type="hidden" name="MACTHD" value="CTDH006">
